...
public class Audio : MonoBehaviour
{
    ...
    private AudioSource[] m_audio = new AudioSource[1];
    private GameObject[] m_play = new GameObject[1];
    private GameObject[] m_pause = new GameObject[1];

    void Start()
    {
        //m_audio[0] = InteractiveSound1;
        //m_audio[1] = InteractiveSound2;
        m_audio[0] = mainInteractiveSound;
        ...
        m_play[0] = GameObject.Find("Textbox3_play_button");
        m_pause[0] = GameObject.Find("Textbox3_pause_button");
